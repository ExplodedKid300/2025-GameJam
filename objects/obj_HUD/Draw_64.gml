...
draw_sprite_ext(spr_gun, 0, 1366, 50, 5, 5, 0, $FFFFFF & $ffffff, 1);
...
/// @DnDArgument : "arg_7" "c_teal"
/// @DnDArgument : "arg_8" "1"
draw_sprite_radial(spr_meter, 2, nShield, ((w/2) * s) + o, ((w/2) * s) + o, -s, s, c_teal, 1);
...
/// @DnDArgument : "var" "string(obj_player.pHealth) + " / " + string(obj_player.mHealth)"
draw_text(((o*2) + (w*s)), 60, string("HP: ") + string(string(obj_player.pHealth) + " / " + string(obj_player.mHealth)));
...
/// @DnDArgument : "var" "string(obj_player.pShield) + " / " + string(obj_player.mShield)"
draw_text(((o*2) + (w*s)), 80, string("SP: ") + string(string(obj_player.pShield) + " / " + string(obj_player.mShield)));
...
for(var i = 0; i < obj_player.mMag; i += 1) {	/// @DnDAction : YoYo Games.Common.If_Expression
	...
	if(i < obj_player.pMag){	/// @DnDAction : YoYo Games.Drawing.Draw_Sprite_Transformed
		...
		/// @DnDHash : 41F21AB5
		/// @DnDParent : 21D12922
		/// @DnDArgument : "x" "((o*2) + (w*s)) + (i * 8)"
		/// @DnDArgument : "y" "35"
		/// @DnDArgument : "rot" "90"
		/// @DnDArgument : "sprite" "bullet"
		/// @DnDArgument : "col" "$FFFFFFFF"
		/// @DnDSaveInfo : "sprite" "bullet"
		draw_sprite_ext(bullet, 0, ((o*2) + (w*s)) + (i * 8), 35, 1, 1, 90, $FFFFFFFF & $ffffff, 1);}
	...
	/// @DnDParent : 2AEDB8C8
		...
		/// @DnDSaveInfo : "sprite" "bullet"
		draw_sprite_ext(bullet, 0, ((o*2) + (w*s)) + (i * 8), 35, 1, 1, 90, $FF7F7F7F & $ffffff, 1);}}